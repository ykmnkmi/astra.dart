...
typedef Start = void Function(
    {int status, String? reason, List<Header>? headers});

typedef Send = FutureOr<void> Function(
    {List<int>? bytes, bool flush, bool end});
...
typedef ExceptionHandler = FutureOr<Response> Function(
    Connection connection, Object error, StackTrace stackTrace);
