...
void main() {
  ...
  test('compose middleware with Pipeline', () async {
    var handler = const Pipeline().addMiddleware(middlewareA).addMiddleware(middlewareB).addHandler(innerHandler);
  ...
  test('extensions for composition', () async {
    var handler = middlewareA.addMiddleware(middlewareB).addHandler(innerHandler);
  ...
  test('Pipeline can be used as middleware', () async {
    var innerPipeline = const Pipeline().addMiddleware(middlewareA).addMiddleware(middlewareB);

    var handler = const Pipeline().addMiddleware(innerPipeline.middleware).addHandler(innerHandler);
