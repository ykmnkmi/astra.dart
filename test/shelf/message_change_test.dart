...
void _testChange(
  ...
  group('body', () {
    ...
    test('with Stream', () async {
      var request = factory(body: 'Hello, world');
      var copy = request.change(body: Stream.fromIterable(['Goodbye, world']).transform(utf8.encoder));
  ...
  test('new header values are added', () {
    ...
    expect(copy.headers, {'test': 'test value', 'test2': 'test2 value', 'content-length': '0'});
  });
